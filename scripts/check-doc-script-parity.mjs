...
const localSmokeStepDocs = new Map([
  ...
  ["core_db_plane_worker_build", "Core/DB/Plane/Worker build"],
  ...
  ["codex_adapter_smoke", "codex:adapter-smoke"],
  ["codex_app_server_smoke", "codex:app-server-smoke"],
  ["worker_codex_smoke", "worker:codex-smoke"],
  [
    "worker_codex_app_server_followup_smoke",
    "WORKER_EXECUTION_ADAPTER=codex-app-server WORKER_CODEX_SMOKE_FOLLOW_UP=true pnpm worker:codex-smoke",
  ],
  ...
  ["worker_fairness_smoke", "worker:fairness-smoke"],
  ["worker_workspace_smoke", "worker:workspace-smoke"],
  ["worker_lease_smoke", "worker:lease-smoke"],
  ["worker_crash_smoke", "worker:crash-smoke"],
  ["worker_budget_smoke", "worker:budget-smoke"],
  ["worker_workflow_smoke", "worker:workflow-smoke"],
  ["workspace_cleanup_smoke", "workspace:cleanup-smoke"],
  ...
  ["cutover_codex_rehearsal", "cutover:codex-rehearsal"],
