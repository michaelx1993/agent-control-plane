...
select
  ...
  (select count(*) from tasks where state in ('Todo', 'Development', 'Code Review', 'In Merge', 'Release Version', 'Deployment')) as agent_queue_length,
  (select count(*) from tasks where state in ('Human Review', 'Merged', 'Released', 'Deployed')) as human_gate_tasks,
